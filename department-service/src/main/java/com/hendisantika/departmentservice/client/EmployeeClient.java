package com.hendisantika.departmentservice.client;

import com.apollographql.apollo.ApolloCall;
import com.apollographql.apollo.ApolloClient;
import com.apollographql.apollo.api.Response;
import com.apollographql.apollo.exception.ApolloException;
import com.hendisantika.departmentservice.model.Employee;
...
public class EmployeeClient {
    ...
    public List<Employee> findByDepartment(Long departmentId) throws InterruptedException {
        ...
        client.query(EmployeesByDepartmentQuery.builder().departmentId(departmentId.intValue()).build()).enqueue(new ApolloCall.Callback<EmployeesByDepartmentQuery.Data>() {
